...
class Product extends ChangeNotifier {
  ...
  Product({this.id, this.name, this.typeText, this.description, this.images, this.sizes}){
   images = images ?? [];
   sizes = sizes ?? [];
  }
  ...
  Product.fromDocument(DocumentSnapshot document){
    ...
    typeText = document['typetext'] as String;
  ...
  // mapeia o menor valor dos produtos disponiveis
  num get basePrice {
  ...
  @override
  String toString() {
    return 'Product{id: $id, name: $name, typeText: $typeText, description: $description, images: $images, sizes: $sizes, newImages: $newImages}';
  }
}